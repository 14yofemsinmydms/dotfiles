...
Singleton {
  ...
  // Shadows
  readonly property real shadowOpacity: (Settings.data.general.shadowIntensity !== undefined ? Settings.data.general.shadowIntensity : 0.70)
  readonly property real shadowBlur: 1.0
  readonly property int shadowBlurMax: (Settings.data.general.shadowBlurMax !== undefined ? Settings.data.general.shadowBlurMax : 40)
  readonly property real shadowScale: (Settings.data.general.shadowScale !== undefined ? Settings.data.general.shadowScale : 1.00)
  readonly property real shadowHorizontalOffset: Settings.data.general.shadowOffsetX !== undefined ? Settings.data.general.shadowOffsetX : 0
  readonly property real shadowVerticalOffset: Settings.data.general.shadowOffsetY !== undefined ? Settings.data.general.shadowOffsetY : 4
